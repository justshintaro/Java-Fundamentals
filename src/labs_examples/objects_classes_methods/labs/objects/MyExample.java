...
public class MyExample {
    ...
    public static void main(String[] args) {
        ...
        Passengers firstPassengers = new Passengers("Marina", 11, 4.11);
        Seat firstSeat = new Seat(false, "S1");

        Airplane firstAirplane = new Airplane(firstStatus, firstRoute, firstPassengers, firstSeat, 123, "low");
        ...
        Passengers secondPassenger = new Passengers("Mike", 45, 5.8);
        Seat secondSeat = new Seat(true, "A12");

        Airplane secondAirplane = new Airplane(secondStatus, secondRoute, secondPassenger, secondSeat, 500.111, "hight");
        ...
        Airplane thirdAirplane = new Airplane(new Status("JAL", true, false), new Route("Tokyo", "New York"),
                new Passengers("David", 34, 5.11),new Seat(true, "N23"), 123, "low");
